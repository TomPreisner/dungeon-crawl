...
class Effect_Damage_Multiply_Test : public Status::Effect_Damage_Multiply {
public:
    explicit Effect_Damage_Multiply_Test(const YAML::Node& node) : Effect_Damage_Multiply(node) {}
...
TEST(Effect_Damage_Multiply, Test_EffectCreation) {
    ...
    EXPECT_EQ(Status::EffectType::DAMAGE_MULTIPLY, test.get_effect_type());
    ...
    // DAMAGE_MULTIPLY
    test = Effect_Damage_Multiply_Test(effect_node[2]);
    EXPECT_EQ(Status::EffectType::NONE, test.get_effect_type());
    EXPECT_FALSE(test.is_valid());
    EXPECT_FALSE(test.public_test_has_valid_amount());
    EXPECT_FALSE(test.public_test_has_valid_callback());
    ...
    // DAMAGE_MULTIPLY
    test = Effect_Damage_Multiply_Test(effect_node[3]);
    EXPECT_EQ(Status::EffectType::NONE, test.get_effect_type());
    EXPECT_FALSE(test.is_valid());
    EXPECT_FALSE(test.public_test_has_valid_amount());
    EXPECT_FALSE(test.public_test_has_valid_callback());
    ...
    // DAMAGE_MULTIPLY
    test = Effect_Damage_Multiply_Test(effect_node[4]);
    EXPECT_EQ(Status::EffectType::DAMAGE_MULTIPLY, test.get_effect_type());
    EXPECT_TRUE(test.is_valid());
    EXPECT_TRUE(test.public_test_has_valid_amount());
    ...
    // DAMAGE_MULTIPLY
    test = Effect_Damage_Multiply_Test(effect_node[5]);
    EXPECT_EQ(Status::EffectType::DAMAGE_MULTIPLY, test.get_effect_type());
    EXPECT_TRUE(test.is_valid());
    EXPECT_TRUE(test.public_test_has_valid_amount());
    ...
    // damage_multiply
    test = Effect_Damage_Multiply_Test(effect_node[6]);
    EXPECT_EQ(Status::EffectType::DAMAGE_MULTIPLY, test.get_effect_type());
    EXPECT_TRUE(test.is_valid());
    EXPECT_TRUE(test.public_test_has_valid_amount());
    ...
    // DAMAGE_MULTIPLY
    test = Effect_Damage_Multiply_Test(effect_node[7]);
    EXPECT_EQ(Status::EffectType::NONE, test.get_effect_type());
    EXPECT_FALSE(test.is_valid());
    EXPECT_FALSE(test.public_test_has_valid_amount());
    EXPECT_FALSE(test.public_test_has_valid_callback());
    ...
    // DAMAGE_MULTIPLY
    test = Effect_Damage_Multiply_Test(effect_node[8]);
    EXPECT_EQ(Status::EffectType::DAMAGE_MULTIPLY, test.get_effect_type());
    EXPECT_TRUE(test.is_valid());
    EXPECT_TRUE(test.public_test_has_valid_amount());
    ...
    // DAMAGE_MULTIPLY
    test = Effect_Damage_Multiply_Test(effect_node[9]);
    EXPECT_EQ(Status::EffectType::NONE, test.get_effect_type());
    EXPECT_FALSE(test.is_valid());
    EXPECT_FALSE(test.public_test_has_valid_amount());
    EXPECT_FALSE(test.public_test_has_valid_callback());
...
TEST(Effect_Damage_Multiply, Test_EffectProcess) {
    // A simple load of a yaml file and validate the contents
    YAML::Node config = YAML::LoadFile(k_yaml_file);
