...
TEST(EffectType, Test_EffectCreation) {
    ...
    EXPECT_EQ(Status::EffectType::NONE, test.effect_type());
    ...
    EXPECT_EQ(Status::EffectType::CLEAR, test.effect_type());
    EXPECT_TRUE(test.public_test_has_valid_amount());
    EXPECT_EQ(2.f, test.public_test_get_amount());
    EXPECT_FALSE(test.public_test_has_valid_callback());
    ...
    EXPECT_EQ(Status::EffectType::DAMAGE, test.effect_type());
    EXPECT_TRUE(test.public_test_has_valid_amount());
    ...
    EXPECT_EQ(Status::EffectType::DAMAGE_PERCENT, test.effect_type());
    EXPECT_TRUE(test.public_test_has_valid_amount());
    ...
    EXPECT_EQ(Status::EffectType::HEAL, test.effect_type());
    EXPECT_TRUE(test.public_test_has_valid_amount());
    ...
    EXPECT_EQ(Status::EffectType::HEAL_PERCENT, test.effect_type());
    EXPECT_TRUE(test.public_test_has_valid_amount());
    ...
    EXPECT_EQ(Status::EffectType::MULTIPLY, test.effect_type());
    EXPECT_TRUE(test.public_test_has_valid_amount());
    EXPECT_EQ(2.f, test.public_test_get_amount());
    EXPECT_FALSE(test.public_test_has_valid_callback());
