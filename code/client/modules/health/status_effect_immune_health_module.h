...
class StatusEffectImmune_HealthModule : public HealthModule {
public:
    StatusEffectImmune_HealthModule() = delete;
    StatusEffectImmune_HealthModule(const std::string& health_module_name, const YAML::Node& data);
