...
class StatusEffectImmune_HealthModule_Test : public Module::StatusEffectImmune_HealthModule {
public:
    StatusEffectImmune_HealthModule_Test(const std::string& name, const YAML::Node& data) : Module::StatusEffectImmune_HealthModule(name, data) {}
    ...
    std::optional<float> test_get_percent_chance() {
        Module::StatusEffect_Descriptor* desc = get_descriptor<Module::StatusEffect_Descriptor>();
        if (desc != nullptr) {
            return desc->get_percent_chance(); 
        }
        return std::nullopt;
    }
};
...
TEST(StatusEffectImmune_HealthModule, Test_StatusEffectImmuneModule_StatusType) {
    ...
    StatusEffectImmune_HealthModule_Test test_case_statusType("TestData_StatusType", test_statusType);
...
TEST(StatusEffectImmune_HealthModule, Test_StatusEffectImmuneModule_StatusType_Invalid) {
    Status::StatusEffectLibrary::get_Instance()->init_from_file(k_yaml_library_file);
    ...
    StatusEffectImmune_HealthModule_Test test_case_statusType_Invalid("TestData_StatusType_Invalid", test_statusType_Invalid);
...
TEST(StatusEffectImmune_HealthModule, Test_StatusEffectImmuneModule_StatusType_50_Percent) {
    Status::StatusEffectLibrary::get_Instance()->init_from_file(k_yaml_library_file);
    ...
    StatusEffectImmune_HealthModule_Test test_case_statusType_50("TestData_StatusType_50_Percent", test_statusType_50);
...
TEST(StatusEffectImmune_HealthModule, Test_StatusEffectImmuneModule_StatusType_NegativePercent) {
    Status::StatusEffectLibrary::get_Instance()->init_from_file(k_yaml_library_file);
    ...
    StatusEffectImmune_HealthModule_Test test_case_statusType_NegativePercent("TestData_StatusType_Negative_Percent", test_statusType_NegativePercent);
...
TEST(StatusEffectImmune_HealthModule, Test_StatusEffectImmuneModule_StatusType_TooMuchPercent) {
    Status::StatusEffectLibrary::get_Instance()->init_from_file(k_yaml_library_file);
    ...
    StatusEffectImmune_HealthModule_Test test_case_statusType_TooMuchPercent("TestData_StatusType_TooMuch_Percent", test_statusType_TooMuchPercent);
...
TEST(StatusEffectImmune_HealthModule, Test_StatusEffectImmuneModule_StatusType_ZeroPercent) {
    Status::StatusEffectLibrary::get_Instance()->init_from_file(k_yaml_library_file);
    ...
    StatusEffectImmune_HealthModule_Test test_case_statusType_ZeroPercent("TestData_StatusType_Zero_Percent", test_statusType_ZeroPercent);
...
TEST(StatusEffectImmune_HealthModule, Test_StatusEffectImmuneModule_StatusType_StatusName) {
    Status::StatusEffectLibrary::get_Instance()->init_from_file(k_yaml_library_file);
    ...
    StatusEffectImmune_HealthModule_Test test_case_StatusName("TestData_StatusName", test_StatusName);
