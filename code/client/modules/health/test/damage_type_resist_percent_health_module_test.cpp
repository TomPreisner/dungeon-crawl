...
class DamageTypeResistPercent_HealthModule_Test : public Module::DamageTypeResistPercent_HealthModule {
public:
    DamageTypeResistPercent_HealthModule_Test(const std::string& name, const YAML::Node& data) : Module::DamageTypeResistPercent_HealthModule(name, data) {}

    std::optional<int32_t> test_get_damage_type() { 
        Module::DamageTypePercent_Descriptor* desc = get_descriptor<Module::DamageTypePercent_Descriptor>();
        if (desc != nullptr) {
    ...
    std::optional<float> test_get_partial_effect_amount() { 
        Module::DamageTypePercent_Descriptor* desc = get_descriptor<Module::DamageTypePercent_Descriptor>();
        if (desc != nullptr) {
            return desc->get_partial_effect_amount(); 
        }
        return std::nullopt;
    }
};
...
TEST(DamageTypeResistPercent_Module, Test_DamageTypeResistPercentModule_Simple_Apply) {
    ...
    DamageTypeResistPercent_HealthModule_Test test_case_simple("TestData_SimplePercent", test_simple);
...
TEST(DamageTypeResistPercent_Module, Test_DamageTypeResistPercentModule_SimplePartial_Apply) {
    ...
    DamageTypeResistPercent_HealthModule_Test test_case_simple_partial("TestData_SimplePercent_Partial", test_simple_partial);
    ...
    EXPECT_EQ(test_output.damage_type() & code::client::messages::Damage::PHYSICAL, code::client::messages::Damage::PHYSICAL);
    EXPECT_EQ(test_output.damage_type() & code::client::messages::Damage::POISON, code::client::messages::Damage::POISON);
    ...
    EXPECT_EQ(test_output_two.damage_type() & code::client::messages::Damage::FIRE, code::client::messages::Damage::FIRE);
    EXPECT_FLOAT_EQ(test_output_two.amount(), 3.2f);
    ...
    EXPECT_EQ(test_output_three.damage_type() & code::client::messages::Damage::POISON, code::client::messages::Damage::POISON);
...
TEST(DamageTypeResistPercent_Module, Test_DamageTypeResistPercentModule_MultipleDamage_Apply) {
    ...
    DamageTypeResistPercent_HealthModule_Test test_case_multi_damage("TestData_MultipleDamagePercent", test_multi_damage);
    ...
    code::client::messages::Damage test_output;
    test_output.set_damage_type(code::client::messages::Damage::MAGIC | code::client::messages::Damage::FIRE);
    test_output.set_amount(3.2f);
...
TEST(DamageTypeResistPercent_Module, Test_DamageTypeResistPercentModule_MultipleDamage_BadPartial_Apply) {
    ...
    DamageTypeResistPercent_HealthModule_Test test_case_multi_damage_partial("TestData_MultipleDamagePercent_BadPartial", test_multi_damage_partial);
...
TEST(DamageTypeResistPercent_Module, Test_DamageTypeResistPercentModule_NoDamage_Apply) {
    ...
    DamageTypeResistPercent_HealthModule_Test test_case_no_damage("TestData_NoDamage", test_no_damage);
...
TEST(DamageTypeResistPercent_Module, Test_DamageTypeResistPercentModule_NoAmount_Apply) {
    ...
    DamageTypeResistPercent_HealthModule_Test test_case_no_amount("TestData_NoAmount", test_no_amount);
...
TEST(DamageTypeResistPercent_Module, Test_DamageTypeResistPercentModule_NegativeAmount_Apply) {
    ...
    DamageTypeResistPercent_HealthModule_Test test_case_negative_amount("TestData_NegativeAmount", test_negative_amount);
...
TEST(DamageTypeResistPercent_Module, Test_DamageTypeResistPercentModule_PercentTooLarge_Apply) {
    ...
    DamageTypeResistPercent_HealthModule_Test test_case_percent_too_large("TestData_PercentTooLarge", test_percent_too_large);
...
TEST(DamageTypeResistPercent_Module, Test_DamageTypeResistPercentModule_PercentPartialNegative_Apply) {
    ...
    DamageTypeResistPercent_HealthModule_Test test_case_percent_partial_negative("TestData_PercentPartialNegative", test_percent_partial_negative);
...
TEST(DamageTypeResistPercent_Module, Test_DamageTypeResistPercentModule_PercentPartialLargerThanAmount_Apply) {
    ...
    DamageTypeResistPercent_HealthModule_Test test_case_percent_partial_larger_than_amount("TestData_PercentPartialLargerThanAmount", test_percent_partial_larger_than_amount);
...
TEST(DamageTypeResistPercent_Module, Test_DamageTypeResistPercentModule_PercentPartialTooLarge_Apply) {
    ...
    DamageTypeResistPercent_HealthModule_Test test_case_percent_partial_too_large("TestData_PercentPartialTooLarge", test_percent_partial_too_large);
