...
class DamageTypeResist_HealthModule_Test : public Module::DamageTypeResist_HealthModule {
public:
    DamageTypeResist_HealthModule_Test(const std::string& name, const YAML::Node& data) : Module::DamageTypeResist_HealthModule(name, data) {}
...
TEST(DamageTypeResist_Module, Test_DamageTypeResistModule_Simple_Apply) {
    ...
    DamageTypeResist_HealthModule_Test test_case_simple("TestData_Simple", test_simple);
...
TEST(DamageTypeResist_Module, Test_DamageTypeResistModule_SimplePartial_Apply) {
    ...
    DamageTypeResist_HealthModule_Test test_case_simple_partial("TestData_Simple_Partial", test_simple_partial);
...
TEST(DamageTypeResist_Module, Test_DamageTypeResistModule_MultipleDamage_Apply) {
    ...
    DamageTypeResist_HealthModule_Test test_case_multi_damage("TestData_MultipleDamage", test_multi_damage);
...
TEST(DamageTypeResist_Module, Test_DamageTypeResistModule_MultipleDamage_BadPartial_Apply) {
    ...
    DamageTypeResist_HealthModule_Test test_case_multi_damage_partial("TestData_MultipleDamage_BadPartial", test_multi_damage_partial);
...
TEST(DamageTypeResist_Module, Test_DamageTypeResistModule_NoDamage_Apply) {
    ...
    DamageTypeResist_HealthModule_Test test_case_no_damage("TestData_NoDamage", test_no_damage);
...
TEST(DamageTypeResist_Module, Test_DamageTypeResistModule_No_Amount_Apply) {
    ...
    DamageTypeResist_HealthModule_Test test_case_no_amount("TestData_NoAmount", test_no_amount);
...
TEST(DamageTypeResist_Module, Test_DamageTypeResistModule_Negative_Amount_Apply) {
    ...
    DamageTypeResist_HealthModule_Test test_case_negative_amount("TestData_NegativeAmount", test_negative_amount);
...
TEST(DamageTypeResist_Module, Test_DamageTypeResistModule_PartialLargerThanAmount_Apply) {
    ...
    DamageTypeResist_HealthModule_Test test_case_partial_larger_than_amount("TestData_PartialLargerThanAmount", test_partial_larger_than_amount);
