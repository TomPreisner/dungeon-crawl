...
namespace Module {
class DamageTypeResist_HealthModule : public HealthModule {
public:
    DamageTypeResist_HealthModule() = delete;
    DamageTypeResist_HealthModule(const std::string& health_module_name, const YAML::Node& data);
